...
mod impl_for_u8 {
    use crate::CITY_HASH_CRC_128_RESULTS;
    use cityhash_sys::CityHashCrc;

    #[test]
    fn hash_crc_256_from_null_ptr() {
        assert_eq!(
            unsafe { core::slice::from_raw_parts(core::ptr::null::<u8>(), 0) }.city_hash_crc_256(),
            [
                10742825796673861936,
                7496450439486572256,
                12948398300027047298,
    ...
    fn hash_crc_256_no_seed() {
        ...
        for index in 0..=255u8 {
            key[index as usize] = index;
            assert_eq!(
                key[0..index as usize].city_hash_crc_256(),
                CITY_HASH_CRC_128_RESULTS[index as usize]
            );
        }
    }
...
mod impl_for_str {
    ...
    fn hash_crc_256_from_str_lipsum() {
        assert_eq!(
            lipsum::LIPSUM.city_hash_crc_256(),
            [
                8704233834023480895,
                13016673051993702793,
                12545694151636899115,
