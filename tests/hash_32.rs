...
mod impl_for_u8 {
    use crate::lipsum;
    use crate::CITY_HASH_32_RESULTS;
    use cityhash_sys::CityHash;

    #[test]
    fn hash_32_from_null_ptr() {
        assert_eq!(
            unsafe { core::slice::from_raw_parts(core::ptr::null::<u8>(), 0) }.city_hash_32(),
            0xDC56D17A
        );
    }
    ...
    fn hash_32_no_seed() {
        ...
        for index in 0..=255u8 {
            key[index as usize] = index;
            assert_eq!(
                key[0..index as usize].city_hash_32(),
                CITY_HASH_32_RESULTS[index as usize]
            );
        }
    }
    ...
    #[test]
    fn hash_32_from_str_lipsum() {
        assert_eq!(lipsum::LIPSUM.as_bytes().city_hash_32(), 0xab8cceb7);
    }
}
...
mod impl_for_str {
    ...
    #[test]
    fn hash_32_from_str_lipsum() {
        assert_eq!(lipsum::LIPSUM.city_hash_32(), 0xab8cceb7);
    }
}
